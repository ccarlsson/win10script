...
# My stuff
#     > powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://git.io/JTPgY')"
#
...
Function InstallBlender {
	Install-Choco-App -Title "Blender" -ChocoInstall "blender"
}

Function InstallNotepad2 {
	Install-Choco-App -Title "Notepad2" -ChocoInstall "notepad2" 
}

Function InstallVisualStudioCode {
	Install-Choco-App -Title "Visual Studio Code" -ChocoInstall "vscode"
}


Function InstallVisualStudio {
	Install-Choco-App -Title "Visual Studio 2019 Community" -ChocoInstall "visualstudio2019community"
}
